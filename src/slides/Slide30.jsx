...
export function Slide3() {
  return (
    <Slide>
      <Note>Claude launches session-evaluator agents to analyze the test runs</Note>
      <ClaudeCodeWeb>
        <Sessions>
          <Session selected>
...
... +4 lines`}
          ...
          <Highlight>
            <Response>
Now I'll analyze all 4 test runs using the session-evaluator subagent. I'll launch them in parallel for efficiency.
            </Response>
          </Highlight>
          ...
          <Highlight>
            <ToolUse>
              ...
              <Command>Analyze test run 0</Command>
              <Result>
{`Analyzing test run 0...
[Agent output placeholder - customize this content]`}
              </Result>
            </ToolUse>
          </Highlight>
